...
public class Signup extends JFrame implements ActionListener {
    ...
    JTextField t1, t2, t3, t4;
      ...
      Signup() {
          ...
          JLabel l4= new JLabel("Security Ques:");
          ...
          ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("tourism/inn/management/system/icon/add-user.png"));
