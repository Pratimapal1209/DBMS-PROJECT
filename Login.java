...
public  class Login extends JFrame implements ActionListener{
    ...
    Login() {
        ...
        p1.setBounds(5, 5, 400, 400); 
        add(p1);
        
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("tourism/inn/management/system/icon/pic8.png"));
        JLabel l1 = new JLabel(i1);
        l1.setBounds(100, 120, 100, 100);
        p1.add(l1);
        ...
        b3 = new JButton("Forgot Passsword");
