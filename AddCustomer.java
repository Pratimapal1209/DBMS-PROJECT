...
public class AddCustomer extends JFrame implements ActionListener{
    ...
    AddCustomer(String username){
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("tourism/inn/management/system/icon/L.png"));
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        String id_type = c1.getSelectedItem();
        ...
        if(r1.isSelected()){
         ...
         String q = "insert into customer values('"+username+"', '"+id_type+"', '"+number+"', '"+name+"', '"+radio+"', '"+country+"', '"+address+"', '"+phone+"','"+email+"')";
         try{
             Con c = new Con();
             c.s.executeUpdate(q);
